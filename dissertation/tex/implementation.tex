...
by a sequential ordering is then \textquote{on an execution path that includes
this assertion site, all the events named in the sequence occur exactly in
order}. There is no restriction on where in the program's execution the events
occur.
...
checking problem in the style of \citeauthor{clarke_design_1982}: \textcquote[p.
