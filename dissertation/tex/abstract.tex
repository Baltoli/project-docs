...
TESLA \cite{anderson_tesla:_2014} is a compiler-based tool that allows temporal
  ...
  server application. To evaluate, I analyse the performance overhead of TESLA
  ...
  time eliminates the run-time overhead completely while retaining the asserted
  safety properties.
